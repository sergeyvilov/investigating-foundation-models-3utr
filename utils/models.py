...
def minseq_model(mpra_df):
    ...
    --nucleotide percentage for each base (+4)
    --dinucleotide percentages (+16)
    --exact dinucleotide counts (+16)
    --maximum homopolymer length for all bases and the maximum among them (+5)
