...
logs_dir=$data_dir'mpra/griesemer_2021/embeddings/'
...
for model_name in stspace-3utr-2e stspace-spaw-3utr-2e  stspace-spaw-3utr-DNA stspace-3utr-DNA stspace-3utr-hs; do
        ...
        srun -p gpu_p --qos=gpu_normal -o ${output_dir}/log.o -e ${output_dir}/log.e --nice=10 -J $model_name-gries -c 4 --mem=64G --gres=gpu:1 --time=1-00:00:00 python -u main_parallel.py ${NN_PARAMETERS} &
