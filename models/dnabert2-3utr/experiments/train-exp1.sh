...
output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/dnabert2-3utr-exp1/'
...
--train_chunks 8 --max_tokens 128 --max_overlap_tokens 25 --tot_epochs 200"
