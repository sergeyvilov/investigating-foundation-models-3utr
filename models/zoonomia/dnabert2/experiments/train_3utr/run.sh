...
output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/zoonomia-3utr/dnabert2-3utr-2e/'
...
--save_at -1 25:100000:25 --species_agnostic  --seed 1 --mixed_precision \
--grad_accum_itr 35 --batch_size 64 --steps_per_chkpt 100 --tot_chkpt 100000"
