...
output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/zoonomia/dnabert2-z/'
...
--grad_accum_itr 7 --batch_size 64 --steps_per_chkpt 350 --tot_chkpt 100000"
