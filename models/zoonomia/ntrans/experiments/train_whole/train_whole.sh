...
model_name=${SLURM_JOB_NAME} #$SLURM_JOB_NAME
...
output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/zoonomia/ntrans-$model_name-z/'
...
--grad_accum_itr 2 --model_name ${model_name} --batch_size $batch_size --steps_per_chkpt 800 --tot_chkpt 10000"
