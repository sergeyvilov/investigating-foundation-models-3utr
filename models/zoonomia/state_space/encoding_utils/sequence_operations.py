...
def plain_one_hot(seq, motifs, padding='none', total_len=None, frame=0):
    ...
    if padding == 'max_length' :
        seq_one_hot, seq_labels, masks = pad_all(seq_one_hot, seq_labels, (motif_mask,), total_len=total_len)
        motif_mask = masks[0]
