...
dataset='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/fasta/Homo_sapiens_rna.fa'

output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/zoonomia-3utr/stspace-3utr-hs/'
...
--save_at -1 1:100000  --species_agnostic  --seed 1  \
--grad_accum_itr 5 --batch_size 256 --steps_per_chkpt 10 --tot_chkpt 100 --species_list ${species_list}"
