...
output_dir='/lustre/groups/epigenereg01/workspace/projects/vale/mlm/models/zoonomia-3utr/stspace-spaw-3utr-2e/'
...
--save_at -1 8:100000:8  --seed 1  \
--grad_accum_itr 5 --batch_size 256 --steps_per_chkpt 200 --tot_chkpt 10000 --species_list ${species_list}"
